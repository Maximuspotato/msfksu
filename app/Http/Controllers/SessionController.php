...
class SessionController extends Controller
{
    ...
    public function currency(Request $request){
        if(!session()->has('rates')){
            $ch = curl_init();
            curl_setopt($ch, CURLOPT_URL, 'https://api.exchangerate.host/latest?base=KES');
            ...
            session()->put('KES_USD', $obj['USD']);
            session()->put('KES_EUR', $obj['EUR']);
            session()->put('KES_CHF', $obj['CHF']);
