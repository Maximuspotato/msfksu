	...
	<div class="section">
        <div class="container">
			@php
				...
				if(isset($_REQUEST['awb']) && trim($_REQUEST['awb']) != ""){
					array_push($tab_filter,array('name'=>'awb','value'=>trim($_REQUEST['awb'])));
				}
			...
			<div class="container" id="grille-param">
				<form method="GET" action="{{URL('/')}}/awb-view" autocomplete="off">
					<div class="div_filter">
					
						<label>AWB:</label>
						<input type="text" name="awb" id="awb" value="<?php if (isset($_REQUEST['awb'])) echo $_REQUEST['awb'];?>" required><br><br>
