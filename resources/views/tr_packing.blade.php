        ...
        <div class="container">
			@php
				...
				$fields[]=array(
					'sqlfield'=>"
					ROUND(SUM(CASE
					WHEN MTR_LIB = 'Air' THEN FCT_MT_BASE_REMISE * PCT_TOT_PDS / TOT.WGHT
					WHEN MTR_LIB = 'Road' THEN FCT_MT_BASE_REMISE * PCT_TOT_VOL / TOT.VOL
					WHEN MTR_LIB = 'Sea' THEN FCT_MT_BASE_REMISE * PCT_TOT_VOL / TOT.VOL
					END),2) ",				// champ SQL pur
